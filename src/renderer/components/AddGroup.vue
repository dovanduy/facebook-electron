<template>
  <el-drawer title="添加小组" :visible.sync="show" size="400px" :before-close="handleClose">
    <el-form ref="form" :model="config" label-width="100px" size="mini">
      ...
      <el-form-item prop="sleepTime" style="width: 85%">
        <div slot="label">
          <el-popover placement="top-start" trigger="hover" content="每隔多久添加一个小组">
            <span slot="reference">
              添加延时
  ...
  methods: {
    ...
    startAdd() {
      ...
      let myNotification = new Notification(
        this.defaultDevice.device_remark + "正在添加小组",
        {
          body:
            "正在自动添加小组, 请暂时不要操作" +
